...
# 11. Nhận vào 2 thông số là đường dẫn lưu file và tên file
if len(sys.argv) < 3:
...
# 12. Gọi API để lấy danh sách laptop và lưu vào file đã được khai báo với đường dẫn và tên file nhập vào
